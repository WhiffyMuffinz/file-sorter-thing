File sorter script. Will take files from the "from" directory, and move them to the "to" directory, making subdirectories with the name of the file extension.
